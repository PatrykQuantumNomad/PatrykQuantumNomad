...
```bash
AUDITOR_MODEL=$(node "/Users/patrykattc/work/git/PatrykQuantumNomad/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read /Users/patrykattc/work/git/PatrykQuantumNomad/.claude/agents/gsd-eval-auditor.md for instructions.
