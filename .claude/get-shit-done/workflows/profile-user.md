...
```bash
cp "/Users/patrykattc/work/git/PatrykQuantumNomad/.claude/get-shit-done/USER-PROFILE.md" "/Users/patrykattc/work/git/PatrykQuantumNomad/.claude/USER-PROFILE.backup.md"
```
...
```bash
BACKUP_PATH="/Users/patrykattc/work/git/PatrykQuantumNomad/.claude/USER-PROFILE.backup.md"
```
