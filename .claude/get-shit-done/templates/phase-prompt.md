...
<!-- For checkpoint task examples and patterns, see @/Users/patrykattc/work/git/PatrykQuantumNomad/.claude/get-shit-done/references/checkpoints.md -->
...
See `/Users/patrykattc/work/git/PatrykQuantumNomad/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Users/patrykattc/work/git/PatrykQuantumNomad/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Users/patrykattc/work/git/PatrykQuantumNomad/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
