...
- Usage: Reference from command with `@/Users/patrykattc/work/git/PatrykQuantumNomad/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/patrykattc/work/git/PatrykQuantumNomad/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/patrykattc/work/git/PatrykQuantumNomad/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
