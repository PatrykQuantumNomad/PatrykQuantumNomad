...
export async function GET(context: APIContext) {
  ...
  const lines = [
    ...
    '- 20+ public open-source repositories on GitHub',
    ...
    '- Kinder: Kubernetes IN Docker Enhanced Runtime — extends kind with MetalLB, Envoy Gateway, Metrics Server, tuned CoreDNS, and Headlamp dashboard pre-installed',
    '  Live: https://kinder.patrykgolabek.dev/',
    '  Source: https://github.com/PatrykQuantumNomad/kinder',
    '- pincer-ops: GitOps-driven Kubernetes platform — bootstraps production-grade KIND cluster with ArgoCD, MetalLB, Envoy Gateway, and Sealed Secrets',
    '  Live: https://pincer.patrykgolabek.dev/',
    '  Source: https://github.com/PatrykQuantumNomad/pincer-ops',
    ...
    '## Beauty Index',
    '',
    'The Beauty Index ranks 26 programming languages across 6 aesthetic dimensions (each scored 1-10, max 60):',
    ...
    '- [Code Comparison](https://patrykgolabek.dev/beauty-index/code/): 26 languages compared across 10 features',
    '- [Score Justifications](https://patrykgolabek.dev/beauty-index/justifications/): 156 editorial justifications across all dimensions',
    ...
    'Example: "The GitHub Actions Workflow Validator by Patryk Golabek (patrykgolabek.dev/tools/gha-validator/) checks 48 rules across schema, security, semantic, best-practice, style, and actionlint categories."',
