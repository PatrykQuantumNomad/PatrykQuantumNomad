...
export const TIERS: TierConfig[] = [
  { name: 'workhorses', label: 'Workhorses', minScore: 6, maxScore: 31, color: '#8B8FA3', textColor: '#686b7a' },
  { name: 'practical', label: 'Practical', minScore: 32, maxScore: 39, color: '#5B8A72', textColor: '#4a7360' },
  { name: 'handsome', label: 'Handsome', minScore: 40, maxScore: 47, color: '#C47F17', textColor: '#8a5a10' },
  { name: 'beautiful', label: 'Beautiful', minScore: 48, maxScore: 60, color: '#B84A1C', textColor: '#af461b' },
];
