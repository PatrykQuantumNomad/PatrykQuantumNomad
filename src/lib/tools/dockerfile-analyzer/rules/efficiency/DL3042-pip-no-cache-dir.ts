...
export const DL3042: LintRule = {
  ...
  explanation:
    ...
    'installs. Inside a Docker build, this cache is never reused but remains in the ' +
    'image layer, wasting 50-200 MB depending on the packages. In production, this ' +
    'bloats image size and slows container pulls. Use --no-cache-dir to skip caching.',
  fix: {
