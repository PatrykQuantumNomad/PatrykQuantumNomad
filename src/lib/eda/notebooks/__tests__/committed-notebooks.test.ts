 ...
 *
 * These tests verify that all 10 case study notebooks
...
describe('committed notebooks', () => {
  it('all 10 case study slugs have corresponding .ipynb files in notebooks/eda/', () => {
  ...
  describe.each(ALL_CASE_STUDY_SLUGS)('%s.ipynb', (slug) => {
    const filePath = join(NOTEBOOKS_DIR, `${slug}.ipynb`);
