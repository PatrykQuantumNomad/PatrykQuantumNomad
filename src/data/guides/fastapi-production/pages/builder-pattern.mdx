...
- <a href="https://fastapi.tiangolo.com/advanced/settings/" target="_blank" rel="noopener noreferrer">FastAPI — Settings and Environment Variables</a>
- <a href="https://www.starlette.io/lifespan/" target="_blank" rel="noopener noreferrer">Starlette Lifespan Events</a>
- <a href="https://refactoring.guru/design-patterns/builder/python/example" target="_blank" rel="noopener noreferrer">Python Builder Pattern — Refactoring Guru</a>
- <a href="https://docs.sqlalchemy.org/en/20/orm/extensions/asyncio.html" target="_blank" rel="noopener noreferrer">SQLAlchemy Async Session Best Practices</a>
