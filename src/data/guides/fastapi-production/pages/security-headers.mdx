...
- <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Security-Policy" target="_blank" rel="noopener noreferrer">MDN — Content-Security-Policy</a>
- <a href="https://datatracker.ietf.org/doc/html/rfc6797" target="_blank" rel="noopener noreferrer">RFC 6797 — HTTP Strict Transport Security (HSTS)</a>
- <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Permissions-Policy" target="_blank" rel="noopener noreferrer">MDN — Permissions-Policy</a>
