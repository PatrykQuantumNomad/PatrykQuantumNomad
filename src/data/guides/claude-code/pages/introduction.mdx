...
keywords: ["claude code", "install claude code", "agentic loop", "ai coding tool", "anthropic", "terminal cli", "code editor ai"]
---
...
Claude Code also asks for your permission before doing anything potentially destructive, like writing files or running shell commands. You can configure these permission rules to match your workflow, covered in detail in the [Models, Costs & Permissions chapter](/guides/claude-code/models-and-costs/).
