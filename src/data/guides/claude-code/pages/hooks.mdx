...
description: "Automate quality enforcement with 24 lifecycle events, conditional if-field filtering, the PermissionDenied event for auto mode integration, and defer decisions for SDK workflows."
order: 7
slug: "hooks"
