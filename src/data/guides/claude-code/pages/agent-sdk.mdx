...
The SDK supports MCP servers through the `mcp_servers` option. MCP (Model Context Protocol) servers extend your agent with external tools like databases, APIs, ticketing systems, and more. See [Model Context Protocol](/guides/claude-code/mcp/) for the full MCP setup guide.
