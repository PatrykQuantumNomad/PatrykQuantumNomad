...
description: "Run Claude Code from any device via remote control, automate with headless mode in CI/CD pipelines, and schedule recurring tasks with cron."
order: 4
slug: "remote-and-headless"
lastVerified: 2026-03-10
updatedDate: 2026-03-13
keywords: ["claude code headless", "ci cd automation", "remote control", "cron scheduling", "github actions claude code", "programmatic api", "json output"]
---
