...
description: "Configure Claude Code's four-tier settings hierarchy, enable macOS Seatbelt or Linux sandbox isolation, and customize the terminal status line."
order: 3
slug: "environment"
lastVerified: 2026-03-10
updatedDate: 2026-03-13
keywords: ["claude code sandbox", "seatbelt macos", "settings hierarchy", "filesystem isolation", "network isolation", "status line", "environment variables"]
---
