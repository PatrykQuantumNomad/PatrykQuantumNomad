...
<figure class="not-prose mb-12 -mx-4 sm:-mx-6 lg:-mx-8">
  <img src="/images/death-by-a-thousand-arrows-cover.svg" alt="The word function rendered in amber monospace font, battered by a rain of red arrow function symbols (=> and ->) falling from above, with cracks and damage marks across the letters" class="w-full rounded-lg" />
</figure>
