...
<Callout>
**Building the images too?** Check your Dockerfiles with the [Dockerfile Analyzer](/tools/dockerfile-analyzer/) -- the companion tool that checks 46 rules for security, efficiency, and maintainability. Read the full guide: [Dockerfile Best Practices](/blog/dockerfile-best-practices/).
</Callout>
