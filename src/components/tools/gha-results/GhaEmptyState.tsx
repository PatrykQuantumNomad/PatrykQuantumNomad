...
interface GhaEmptyStateProps {
  score: number;
  grade: string;
}

export function GhaEmptyState({ score, grade }: GhaEmptyStateProps) {
  return (
    <div className="flex flex-col items-center justify-center h-full text-center py-8">
      ...
      <p className="text-sm text-[var(--color-text-secondary)] max-w-xs mb-4">
        Your GitHub Actions workflow follows all best practices. Great job!
      </p>
