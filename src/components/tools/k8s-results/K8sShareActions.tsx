...
import { downloadK8sBadgePng } from '../../../lib/tools/k8s-analyzer/badge-generator';
import {
  buildShareUrl,
  isUrlSafeLength,
} from '../../../lib/tools/k8s-analyzer/url-state';
import { K8sPromptGenerator } from './K8sPromptGenerator';

export function K8sShareActions() {
  ...
  const handleDownloadBadge = async () => {
    setDownloading(true);
    try {
      await downloadK8sBadgePng(result.score);
    } catch (err) {
