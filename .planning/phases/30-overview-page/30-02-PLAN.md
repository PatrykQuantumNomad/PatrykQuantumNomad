...
must_haves:
  truths:
    ...
    - "The page has an SEO-optimized meta title and description under 160 characters"
...
<task type="auto">
  ...
  <action>
    ...
    **Frontmatter:**
    ...
    - Import all components: ComplexitySpectrum, ModelCardGrid, CompassScoringTable, DimensionLegend, CompassJsonLd, UseCaseFilter, BreadcrumbJsonLd, CapBadge
    ...
    **Layout wrapper:**
    ...
    - Description: `"Interactive database model comparison tool. Compare Key-Value, Document, Relational, Graph, and 8 more models scored across scalability, performance, reliability, and 5 other dimensions."` (under 160 chars) (SEO-06)
  ...
  <verify>
    ...
    5. Check meta: `grep 'meta.*description' dist/tools/db-compass/index.html` -- description present
    6. Check data attributes: `grep 'data-model-id' dist/tools/db-compass/index.html` -- 12 model cards have data attributes
  </verify>
  <done>
    Overview page at /tools/db-compass/ renders: hero section, complexity spectrum, use-case filter with 10 category toggles, 12-card model grid with radar thumbnails, sortable scoring table, dimension legend. JSON-LD Dataset+ItemList and BreadcrumbList present. SEO title and description set. Build passes clean.
  </done>
</task>
...
4. Page meta description is under 160 characters and contains database-related keywords
...
- SEO meta title and description are present and optimized
