...
must_haves:
  ...
  artifacts:
    ...
    - path: "src/pages/projects/index.astro"
      provides: "initCardGlow() mousemove handler in inline script"
      contains: "initCardGlow"
  ...
  key_links:
    ...
    - from: "src/pages/projects/index.astro"
      ...
      via: "initCardGlow() sets --mouse-x/--mouse-y CSS vars consumed by ::after radial-gradient"
      pattern: "--mouse-x"
...
9. initCardGlow() function exists in projects/index.astro inline script
</verification>
