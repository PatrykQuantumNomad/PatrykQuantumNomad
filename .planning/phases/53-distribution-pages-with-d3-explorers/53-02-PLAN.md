...
- `distributionUrl` from routes
  ...
  <verify>
    <automated>cd /Users/patrykattc/work/git/PatrykQuantumNomad && npm run build 2>&1 | tail -10 && echo "--- Checking distribution pages ---" && ls dist/eda/distributions/normal/index.html dist/eda/distributions/beta/index.html dist/eda/distributions/binomial/index.html dist/eda/distributions/poisson/index.html dist/eda/distributions/tukey-lambda/index.html 2>&1 && echo "--- Checking page count ---" && ls dist/eda/distributions/*/index.html 2>/dev/null | wc -l</automated>
...
- npm run build produces 19 distribution page HTML files with no errors
