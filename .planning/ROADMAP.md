...
Plans:
- [x] 14-01-PLAN.md -- CSS category glow system and enhanced card components (tech pills, status badges, category glow)
- [x] 14-02-PLAN.md -- Category headers with monospace project count metadata
