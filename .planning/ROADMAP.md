...
- [x] **Phase 131: Evaluation Harness** - Run RAGAS metrics and cost/latency tracking across all 5 tiers with comparison output (completed 2026-04-27; 7/7 plans complete; live smoke DEFERRED in-sandbox — no populated index for any live-capable tier; user runs full-corpus eval locally; code + 135 non-live tests green)
...
- [x] 131-02-PLAN.md — Per-tier adapters (Tiers 1, 2, 3, 5) implementing run_tierN(question) -> EvalRecord (completed 2026-04-27)
...
- [x] 131-07-PLAN.md — README + live smoke test + Phase 131 close-out (completed 2026-04-27; live smoke DEFERRED in-sandbox — chroma_db/tier-1-naive empty + tier-2-managed/.store_id missing + lightrag_storage/tier-3-graph empty; smoke code shipped + statically verified; 135/4/10 non-live suite green; comparison.md awaiting user's first full-corpus run)
...
| 131. Evaluation Harness | v1.22 | 7/7 | ✅ Complete (live smoke DEFERRED — sandbox lacks populated indices for any live-capable tier; user runs full-corpus eval locally; code + non-live suite 135/4/10 green; README + smoke test + comparison.md emitter all shipped; comparison.md awaiting user's first run) | 2026-04-27 |
