...
- [ ] **Phase 96: Notebook Foundation** - TypeScript nbformat v4.5 types, cell factories, case study registry, and requirements.txt template
...
|-------|----------------|--------|-----------|
| 96. Notebook Foundation | 0/TBD | Not started | - |
