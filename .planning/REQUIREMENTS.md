...
- [ ] **INFRA-06**: Existing FastAPI guide renders identically after all infrastructure changes (regression gate)
- [ ] **INFRA-07**: CodeBlock component for inline code snippets without GitHub source attribution
...
- [ ] **DIAG-01**: Build-time SVG diagram — Agentic Loop (gather context → take action → verify results cycle)
- [ ] **DIAG-02**: Build-time SVG diagram — Hook Lifecycle (13+ lifecycle events with branching execution paths)
...
- [ ] **DIAG-05**: Build-time SVG diagram — Agent Teams (lead agent, subagents, shared task list, mailboxes)

### Interactive Components

- [ ] **INTV-01**: Interactive permission flow explorer (React Flow clickable decision tree with allow/ask/deny paths)
