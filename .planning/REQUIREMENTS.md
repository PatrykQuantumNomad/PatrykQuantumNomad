...
- [x] **GRAPH-02**: Job dependency edges from `needs:` declarations with cycle detection
...
- [x] **DOC-04**: GA-L017/GA-L018 rule pages note browser WASM limitation with CLI recommendation
